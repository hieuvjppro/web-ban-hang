...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('../css/danh-sach-sp/img/logoo.png');">
			<div style="background-color: rgb(153, 61, 161); width: 500px; border-radius: 10px; overflow: hidden; padding: 55px 55px 37px 55px;">
				<form class="login100-form validate-form" method = "post">
					<span class="login100-form-logo">
					<a href="../../bigshoes/trang-chinh/index.php"><img src="../css/danh-sach-sp/img/logoo.png" width = "80px" alt=""></a>
					</span>
