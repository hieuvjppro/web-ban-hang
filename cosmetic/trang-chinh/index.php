...
<body>
    ...
    <div id="header">
            <div id="header-first">
                ...
                <div id="header-logo">
                    <a href="" class="header-logo"> ĐKP COSMETIC</a>
            ...
            <div id="header-second">
                <div class="task-bar">
                    <ul class="nav">
                        ...
                        <li><a href="gioi-thieu.php">Kiến Thức Chăm Sóc Da</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="caption">
                    ...
                    <h2> SẢN PHẨM MỚI <span>MÙA ĐÔNG 2023</span></h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row ">
            ...
            <div class="col-md-6">
                <div class="newjus">
                    <ul>
                        <li>
                            <h2>CTKM SALE UP TO<span> 20%</span> toàn bộ sản phẩm tại shop !</h2>
                        </li>
